# Cartographer - Code Flow Visualizer
...
3. Run command: `Cartographer: Visualize Current File`
...
```json
{
  "cartographer.autoRefresh": true,
  "cartographer.layout": "dagre"
}
```
